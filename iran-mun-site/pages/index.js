...
const COUNTRIES = [
  ...
  { name: "Commonwealth of Australia", flag: "🇦🇺", route: '/australia', committee: 'ECOSOC · HRC · DISEC · UNEP', tags: ['Live Intel', 'Power Figures', 'AUKUS & Indo-Pacific', 'MUN Toolkit', 'SACUL AI'], tagColor: '#00008B', btnColor: '#00008B', border: '#d8d8f0', bg: '#f8f8ff', keywords: ['australia', 'canberra', 'sydney', 'albanese', 'aukus', 'quad', 'pacific', 'aboriginal', 'coral', 'indo-pacific', 'five eyes'] },
]
            ...
            <div style={{ background: 'white', border: '1px solid #dde3ea', padding: 24 }}>
              ...
              <div style={{ marginBottom: 20 }}>
                <div style={{ position: 'relative', maxWidth: 400 }}>
                  ...
                  <input
                    type="text"
                    placeholder="Search countries — Iran, China, Nigeria, France, Australia..."
                    value={countrySearch}
